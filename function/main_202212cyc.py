...
#載入電壓資料
data_S7 = data_arrange.load_txt_data('S7_test_202212CYC030.lvm', '\t', 22)
data_S9 = data_arrange.load_txt_data('S9_test_202212CYC030.lvm', '\t', 22)
...
#多組特定時間彎矩回歸線
fitting_output_list=[]
for i in time_index_202212CYC030:
    print(i)
...
for i in range(add_raw):
    time_Z_P.append(all_list[i][2][depth_list[0]]) 
    time_Z_Y.append(all_list[i][4][depth_list[0]]) 
